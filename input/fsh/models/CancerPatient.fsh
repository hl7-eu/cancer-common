...
* birthDate ^definition = "At least the year must be present"
* sexAtBirth 0..1 CodeableConcept "SexAtBirth"
* sexAtBirth ^definition = "Choice: Male | Female | Unknown | Other"
* observedSexGender 0..1 CodeableConcept "ObservedSex Gender"
* observedSexGender ^definition = "It shall be present at least when SexAtBirth is not provided. See https://confluence.hl7.org/spaces/VOC/pages/40743893/The+Gender+Harmony+Project"
