...
* type = "Category of systemic treatment (e.g. chemotherapy, immunotherapy, targeted therapy, hormonal therapy)."
* startDate 1..1 dateTime "StartDate"
* startDate = "Start date of the systemic treatment course."
